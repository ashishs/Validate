...
namespace Validate.Extensions
{
    ...
    public static class ValidatorX
    {
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsNotNull() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsNotNullOrEmpty() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsNullOrEmpty() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsBetween() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsNotBetween() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsTrue() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsFalse() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForMatchesRegex() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForContains() : new ValidationMessage(message);
        ...
        {
            var validationMessage = message == null ? ValidationMessageRepository.Instance.GetValidationMessageForIsOneOf() : new ValidationMessage(message);
